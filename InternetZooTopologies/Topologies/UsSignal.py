...
class UsSignal(Topo):
    def __init__(self):
        ...
        self.addLink(s16, s42)
        self.addLink(s17, s36)
        self.addLink(s17, s37)
        self.addLink(s18, s19)
        self.addLink(s18, s47)
        self.addLink(s20, s22)
        self.addLink(s20, s21)
        self.addLink(s22, s32)
...
topos = {"UsSignal": (lambda: UsSignal())}
