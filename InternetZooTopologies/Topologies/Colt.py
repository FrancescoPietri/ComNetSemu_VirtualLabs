...
class Colt(Topo):
    def __init__(self):
        ...
        self.addLink(s10, s98)
        self.addLink(s10, s101)
        self.addLink(s10, s11)
        self.addLink(s10, s13)
        self.addLink(s12, s141)
        self.addLink(s12, s30)
        self.addLink(s13, s119)
        self.addLink(s14, s17)
        self.addLink(s14, s141)
        self.addLink(s15, s18)
        self.addLink(s15, s19)
        self.addLink(s15, s132)
        self.addLink(s16, s51)
        self.addLink(s16, s60)
        self.addLink(s17, s136)
        self.addLink(s17, s134)
        self.addLink(s17, s133)
        self.addLink(s17, s143)
        self.addLink(s18, s142)
        self.addLink(s19, s49)
        self.addLink(s20, s23)
        self.addLink(s21, s81)
        self.addLink(s22, s23)
        self.addLink(s23, s151)
        self.addLink(s24, s81)
        self.addLink(s25, s81)
        self.addLink(s26, s81)
        self.addLink(s27, s81)
        self.addLink(s28, s140)
        self.addLink(s28, s29)
        self.addLink(s30, s118)
        self.addLink(s30, s119)
        self.addLink(s31, s119)
        self.addLink(s32, s33)
        self.addLink(s32, s35)
        self.addLink(s33, s74)
        self.addLink(s33, s38)
        self.addLink(s34, s119)
        self.addLink(s35, s74)
        self.addLink(s36, s73)
        self.addLink(s36, s39)
        self.addLink(s37, s73)
        self.addLink(s38, s74)
        self.addLink(s39, s124)
        self.addLink(s40, s142)
        self.addLink(s41, s142)
        self.addLink(s42, s142)
        self.addLink(s43, s142)
        self.addLink(s44, s142)
        self.addLink(s45, s49)
        self.addLink(s46, s142)
        self.addLink(s47, s142)
        self.addLink(s48, s49)
        self.addLink(s49, s129)
        self.addLink(s50, s56)
        self.addLink(s50, s58)
        self.addLink(s50, s51)
        self.addLink(s50, s52)
        self.addLink(s50, s53)
        self.addLink(s51, s136)
        self.addLink(s51, s53)
        self.addLink(s51, s92)
        self.addLink(s51, s127)
        self.addLink(s53, s92)
        self.addLink(s54, s139)
        self.addLink(s54, s140)
        self.addLink(s54, s55)
        self.addLink(s55, s140)
        self.addLink(s56, s57)
        self.addLink(s56, s59)
        self.addLink(s58, s59)
        self.addLink(s60, s128)
        self.addLink(s60, s144)
        self.addLink(s61, s81)
        self.addLink(s62, s115)
        self.addLink(s62, s140)
        self.addLink(s62, s94)
        self.addLink(s63, s125)
        self.addLink(s63, s126)
        self.addLink(s64, s72)
        self.addLink(s64, s126)
        self.addLink(s65, s152)
        self.addLink(s66, s152)
        self.addLink(s66, s68)
        self.addLink(s67, s152)
        self.addLink(s68, s81)
        self.addLink(s68, s108)
        self.addLink(s69, s152)
        self.addLink(s70, s152)
        self.addLink(s71, s152)
        self.addLink(s72, s152)
        self.addLink(s73, s120)
        self.addLink(s73, s117)
        self.addLink(s74, s117)
        self.addLink(s74, s125)
        self.addLink(s75, s140)
        self.addLink(s75, s150)
        self.addLink(s76, s140)
        self.addLink(s76, s77)
        self.addLink(s77, s150)
        self.addLink(s78, s115)
        self.addLink(s78, s94)
        self.addLink(s78, s142)
        self.addLink(s79, s137)
        self.addLink(s79, s122)
        self.addLink(s79, s84)
        self.addLink(s80, s137)
        self.addLink(s80, s151)
        self.addLink(s81, s107)
        self.addLink(s81, s93)
        self.addLink(s82, s123)
        self.addLink(s82, s138)
        self.addLink(s82, s83)
        self.addLink(s82, s84)
        self.addLink(s85, s123)
        self.addLink(s86, s121)
        self.addLink(s86, s122)
        self.addLink(s86, s151)
        self.addLink(s87, s152)
        self.addLink(s88, s152)
        self.addLink(s89, s152)
        self.addLink(s90, s138)
        self.addLink(s91, s140)
        self.addLink(s91, s150)
        self.addLink(s95, s107)
        self.addLink(s96, s152)
        self.addLink(s97, s100)
        self.addLink(s98, s101)
        self.addLink(s99, s102)
        self.addLink(s101, s104)
        self.addLink(s103, s152)
        self.addLink(s105, s106)
        self.addLink(s105, s108)
        self.addLink(s106, s152)
        self.addLink(s107, s111)
        self.addLink(s109, s112)
        self.addLink(s109, s152)
        self.addLink(s110, s152)
        self.addLink(s111, s112)
        self.addLink(s113, s152)
        self.addLink(s114, s152)
        self.addLink(s115, s139)
        self.addLink(s116, s142)
        self.addLink(s117, s118)
        self.addLink(s118, s139)
        self.addLink(s121, s148)
        self.addLink(s123, s145)
        self.addLink(s123, s139)
        self.addLink(s123, s124)
        self.addLink(s129, s131)
        self.addLink(s130, s143)
        self.addLink(s131, s143)
        self.addLink(s132, s143)
        self.addLink(s134, s135)
        self.addLink(s135, s136)
        self.addLink(s138, s152)
        self.addLink(s139, s146)
        self.addLink(s139, s149)
        self.addLink(s140, s142)
        self.addLink(s146, s147)
        self.addLink(s148, s149)


topos = {"Colt": (lambda: Colt())}
