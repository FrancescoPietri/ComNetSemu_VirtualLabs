...
class TataNld(Topo):
    def __init__(self):
        ...
        self.addLink(s15, s71)
        self.addLink(s16, s17)
        self.addLink(s19, s119)
        ...
        self.addLink(s32, s130)
        self.addLink(s32, s131)
        self.addLink(s32, s117)
        self.addLink(s33, s117)
        self.addLink(s33, s38)
        self.addLink(s34, s60)
        self.addLink(s35, s68)
        self.addLink(s36, s37)
        self.addLink(s36, s39)
        self.addLink(s37, s74)
        self.addLink(s37, s118)
        self.addLink(s38, s39)
        self.addLink(s40, s41)
        self.addLink(s40, s142)
        self.addLink(s40, s47)
        self.addLink(s41, s46)
        self.addLink(s42, s108)
        self.addLink(s43, s139)
        self.addLink(s43, s108)
        self.addLink(s44, s46)
        self.addLink(s45, s48)
        self.addLink(s45, s124)
        self.addLink(s46, s128)
        self.addLink(s46, s47)
        self.addLink(s46, s123)
        self.addLink(s46, s124)
        self.addLink(s47, s107)
        self.addLink(s48, s49)
        self.addLink(s50, s58)
        self.addLink(s51, s136)
        self.addLink(s51, s58)
        self.addLink(s52, s132)
        self.addLink(s52, s133)
        ...
        self.addLink(s63, s80)
        self.addLink(s64, s65)
        self.addLink(s65, s98)
        self.addLink(s66, s98)
        self.addLink(s67, s98)
        self.addLink(s67, s87)
        self.addLink(s68, s69)
        self.addLink(s69, s79)
        self.addLink(s70, s118)
        self.addLink(s71, s72)
        self.addLink(s71, s95)
        self.addLink(s72, s73)
        self.addLink(s73, s120)
        self.addLink(s73, s96)
        self.addLink(s75, s97)
        self.addLink(s75, s82)
        self.addLink(s76, s97)
        self.addLink(s76, s99)
        self.addLink(s76, s77)
        self.addLink(s77, s102)
        self.addLink(s77, s78)
        self.addLink(s78, s84)
        self.addLink(s78, s85)
        self.addLink(s80, s81)
        self.addLink(s81, s82)
        self.addLink(s83, s141)
        self.addLink(s83, s86)
        self.addLink(s84, s85)
        self.addLink(s86, s107)
        self.addLink(s87, s88)
        self.addLink(s87, s95)
        self.addLink(s88, s93)
        self.addLink(s88, s94)
        self.addLink(s88, s95)
        self.addLink(s89, s90)
        self.addLink(s89, s92)
        self.addLink(s90, s91)
        self.addLink(s91, s92)
        self.addLink(s91, s94)
        self.addLink(s91, s105)
        self.addLink(s93, s120)
        self.addLink(s94, s126)
        self.addLink(s95, s96)
        self.addLink(s95, s120)
        self.addLink(s97, s98)
        self.addLink(s98, s100)
        self.addLink(s98, s104)
        ...
        self.addLink(s108, s141)
        self.addLink(s109, s116)
        self.addLink(s109, s110)
        self.addLink(s110, s112)
        self.addLink(s110, s111)
        self.addLink(s112, s117)
        self.addLink(s113, s144)
        self.addLink(s113, s129)
        self.addLink(s113, s114)
        self.addLink(s113, s115)
        self.addLink(s114, s115)
        self.addLink(s115, s116)
        self.addLink(s119, s120)
        self.addLink(s119, s122)
        self.addLink(s120, s125)
        self.addLink(s121, s128)
        self.addLink(s122, s123)
        self.addLink(s125, s127)
        self.addLink(s126, s128)
        self.addLink(s126, s127)
        self.addLink(s127, s128)
        self.addLink(s129, s130)
        self.addLink(s129, s144)
        self.addLink(s129, s143)
        self.addLink(s130, s134)
        self.addLink(s131, s132)
        self.addLink(s133, s136)
        self.addLink(s134, s135)
        self.addLink(s135, s136)
        self.addLink(s137, s138)
        self.addLink(s137, s139)
        self.addLink(s138, s140)
        self.addLink(s140, s141)
        self.addLink(s141, s142)


topos = {"TataNld": (lambda: TataNld())}
