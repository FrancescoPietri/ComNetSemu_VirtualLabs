...
class Oteglobe(Topo):
    def __init__(self):
        ...
        self.addLink(s4, s79)
        self.addLink(s6, s7)
        self.addLink(s10, s56)
        self.addLink(s11, s16)
        self.addLink(s12, s72)
        self.addLink(s13, s56)
