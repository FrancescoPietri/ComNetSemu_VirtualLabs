...
class Tw(Topo):
    def __init__(self):
        ...
        self.addLink(s10, s70)
        self.addLink(s10, s11)
        self.addLink(s10, s57)
        self.addLink(s11, s71)
        self.addLink(s12, s72)
        self.addLink(s12, s34)
        self.addLink(s12, s13)
        self.addLink(s12, s47)
        self.addLink(s14, s36)
        self.addLink(s14, s15)
        self.addLink(s15, s72)
        self.addLink(s15, s27)
        self.addLink(s15, s63)
        self.addLink(s16, s17)
        self.addLink(s16, s25)
        self.addLink(s17, s38)
        self.addLink(s17, s44)
        ...
        self.addLink(s25, s40)
        self.addLink(s25, s41)
        self.addLink(s25, s53)
        self.addLink(s25, s63)
        self.addLink(s25, s61)
        self.addLink(s25, s31)
        self.addLink(s26, s64)
        self.addLink(s26, s58)
        self.addLink(s26, s53)
        self.addLink(s26, s31)
        self.addLink(s27, s72)
        self.addLink(s27, s41)
