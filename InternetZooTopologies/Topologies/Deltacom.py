...
class Deltacom(Topo):
    def __init__(self):
        ...
        self.addLink(s47, s84)
        self.addLink(s47, s111)
        self.addLink(s47, s60)
        self.addLink(s48, s57)
        self.addLink(s48, s49)
        self.addLink(s49, s84)
        self.addLink(s49, s54)
        self.addLink(s50, s57)
        self.addLink(s50, s91)
        self.addLink(s50, s52)
        self.addLink(s50, s51)
        self.addLink(s52, s53)
        self.addLink(s53, s59)
        self.addLink(s53, s60)
        self.addLink(s54, s56)
        self.addLink(s54, s90)
        self.addLink(s54, s111)
        self.addLink(s54, s55)
        self.addLink(s55, s94)
        self.addLink(s55, s111)
        self.addLink(s56, s57)
        self.addLink(s58, s105)
        self.addLink(s58, s61)
        self.addLink(s58, s110)
        self.addLink(s59, s60)
        self.addLink(s60, s104)
        self.addLink(s60, s97)
        self.addLink(s61, s82)
        self.addLink(s62, s80)
        self.addLink(s62, s70)
        self.addLink(s62, s85)
        self.addLink(s63, s85)
        ...
        self.addLink(s73, s98)
        self.addLink(s74, s112)
        self.addLink(s74, s75)
        self.addLink(s74, s103)
        self.addLink(s75, s104)
        self.addLink(s75, s76)
        self.addLink(s76, s100)
        self.addLink(s77, s81)
        self.addLink(s77, s100)
        self.addLink(s77, s103)
        self.addLink(s78, s101)
        self.addLink(s79, s102)
        self.addLink(s81, s101)
        self.addLink(s82, s83)
        self.addLink(s87, s88)
        self.addLink(s88, s93)
        self.addLink(s89, s96)
        ...
        self.addLink(s99, s104)
        self.addLink(s99, s112)
        self.addLink(s100, s102)
...
topos = {"Deltacom": (lambda: Deltacom())}
