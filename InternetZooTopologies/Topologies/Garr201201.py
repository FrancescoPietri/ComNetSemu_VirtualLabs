...
class Garr201201(Topo):
    def __init__(self):
        ...
        self.addLink(s10, s44)
        self.addLink(s10, s45)
...
topos = {"Garr201201": (lambda: Garr201201())}
