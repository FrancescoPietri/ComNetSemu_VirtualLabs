...
class Internode(Topo):
    def __init__(self):
        ...
        self.addLink(s8, s45)
        self.addLink(s9, s45)
        self.addLink(s10, s53)
        self.addLink(s10, s54)
        self.addLink(s10, s47)
        ...
        self.addLink(s16, s59)
        self.addLink(s16, s38)
        self.addLink(s16, s25)
        self.addLink(s18, s40)
        self.addLink(s18, s37)
        self.addLink(s18, s39)
        self.addLink(s19, s43)
        self.addLink(s19, s45)
...
topos = {"Internode": (lambda: Internode())}
