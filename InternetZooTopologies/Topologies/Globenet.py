...
class Globenet(Topo):
    def __init__(self):
        ...
        self.addLink(s26, s63)
        self.addLink(s28, s43)
        self.addLink(s29, s34)
        self.addLink(s29, s43)
        self.addLink(s29, s30)
        self.addLink(s30, s44)
        self.addLink(s31, s51)
        self.addLink(s31, s52)
        self.addLink(s31, s53)
        self.addLink(s32, s52)
        self.addLink(s32, s53)
...
topos = {"Globenet": (lambda: Globenet())}
